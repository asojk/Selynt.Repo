    ...
    <div className="min-h-screen">
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="mb-8 text-center">
          <img src={images.logo} className='h-12 w-auto mx-auto mb-4' />
          <h1 className="text-3xl prose-n-900 sm:text-4xl">
            Selynt LLC Terms of Service
          </h1>
        ...
        <div className="prose-n-900 max-w-none space-y-4">
          <p>
            Welcome to <a className="text-s">selynt.com</a>,
            owned and operated by <strong>Selynt LLC</strong>. By accessing or using our website, you agree to
          ...
          <ul>
            <li>
              <strong>Eligibility</strong>: By accessing our site, you represent that you are at least 18 years
              old and have the legal authority to enter into this agreement.
            </li>
            <li>
          ...
          <ul>
            <li>
              All content, graphics, design elements, and code are the intellectual property of <strong>Selynt LLC</strong>
          ...
          <ul>
            <li>
              ...
              practices of these sites and encourage you to review their policies.
            </li>
          </ul>
          ...
          <ul>
            <li>
              These terms are governed by the laws of the State of Iowa. Any disputes arising from these terms
              shall be resolved in accordance with Iowa law.
            </li>
          </ul>
