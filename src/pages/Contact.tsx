...
export const Contact = () => {
  return (
		<div className='overflow-x-clip min-h-screen justify-center content-center bg-n-9 antialiased dark:bg-n-6 lg:subpixel-antialiased'>
    ...
    text={
      <>
        <strong>Have questions?</strong> We'd love to help! Contact support for any issue you
        may face.
      </>
    }
    examples={[
