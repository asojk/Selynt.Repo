	...
	return (
			<Link to={href}>
					<motion.div
							...
							<motion.div
									className='absolute inset-0 justify-center items-center h-[3.2rem] w-[3.2rem] rounded-full bg-gradient-to-r from-n-dark to-n-900 dark:from-s dark:to-s-dark'
