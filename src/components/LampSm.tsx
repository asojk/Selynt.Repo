	...
	return (
		<div className="relative w-full ">
			<motion.div
				...
				<motion.div className="relative flex h-full w-full items-center justify-center" transition={transition}>
					<LampGradientSmall />
...
const LampGradientSmall = () => (
	<div className="absolute left-0 right-0 top-0 z-0 flex min-h-[40vh] w-full flex-col items-center justify-center  ">
