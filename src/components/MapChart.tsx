...
const MapChart: React.FC = () => {
	...
	return (
		<div
			...
			<div className="aspect-video w-full md:aspect-[9/12]">
				<ComposableMap projection="geoAlbersUsa" className={`w-full ${isFullScreen ? 'h-screen' : 'h-full'}`}>
			...
			<AnimatePresence>
				{showPopup && activeClient && (
					<motion.div
						...
						className="fixed left-1/2 top-1/2 z-50 w-11/12 max-w-md -translate-x-1/2 -translate-y-1/2 transform rounded-lg border-2 border-n-7 bg-n-light p-6 shadow-lg dark:border-n-4 dark:bg-n-dark md:p-8">
						<button
