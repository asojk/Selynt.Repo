		...
		<div className='relative flex min-h-[90vh] flex-col items-center justify-end'>
			...
			<div className='absolute top-1/3 z-[1000]'>
				<div className='relative max-w-[85vw]'>
					{/* Floating Orb */}
					<div className='absolute inset-0 left-1/2 z-[888] flex h-24 w-24 animate-float items-center justify-center rounded-full bg-s opacity-70 blur-3xl filter md:-top-1/3 md:h-64 md:w-64 lg:-top-1/2 lg:h-72 lg:w-72 lg:opacity-30' />
