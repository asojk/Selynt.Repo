	...
	<>
		...
		<section className="bg-primary-dark py-20 text-white">
			<div className="mx-auto max-w-6xl text-center">
				...
				<a
					href="#services"
					className="bg-alternative hover:bg-alternative-dark mt-8 inline-block rounded-lg px-6 py-3 text-white transition">
		...
		{/* Services Section */}
		<section id="services" className="bg-neutral-light py-16">
			<div className="mx-auto max-w-7xl text-center">
				<h3 className="text-primary-dark text-3xl font-bold">What We Offer</h3>
		...
		<section className="bg-primary-light py-16">
			<div className="mx-auto max-w-7xl text-center">
				<h3 className="text-primary-dark text-3xl font-bold">Get in Touch</h3>
