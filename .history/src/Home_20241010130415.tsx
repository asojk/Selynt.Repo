...
export const Home = () => (
	<div className='bg-n-light dark:bg-n-dark antialiased'>
		<div className='relative flex flex-col justify-end items-center min-h-[90vh]'>
			...
			<div className="absolute -top-48 left-0 transform -translate-x-1/2 lg:-top-64">
				<div className="w-full h-full bg-s rounded-full filter blur-3xl opacity-70 animate-float" />
			</div>
