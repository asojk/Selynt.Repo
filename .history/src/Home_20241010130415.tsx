...
export const Home = () => (
	<div className="bg-n-light antialiased dark:bg-n-dark">
		<div className="relative flex min-h-[90vh] flex-col items-center justify-end">
			...
			<div className="absolute -top-48 left-0 -translate-x-1/2 transform lg:-top-64">
				<div className="h-full w-full animate-float rounded-full bg-s opacity-70 blur-3xl filter" />
			</div>
