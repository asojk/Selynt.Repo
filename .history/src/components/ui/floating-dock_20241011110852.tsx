...
function IconContainer({ title, icon, href, index }: IconContainerProps) {
	...
	// Position the icons between the top (0) and top-left (π/2) quadrants
	const angle = (Math.PI / 2) * (index / 3) // Adjust 3 to the total number of icons in the desired range
