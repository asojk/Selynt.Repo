			...
			<motion.div
				...
				<div
					className={cn(
						...
						'origin-bottom-right overflow-hidden rounded-tl-full',
						className
					)}
					style={{
						scale: scale.get(),
					...
					{isOpen && (
						<div
							className="absolute inset-0 rounded-tl-full border-[6rem] border-b-0 border-r-0 border-white"
							style={{
				...
				<AnimatePresence>
					{hovered && (
						<motion.div
							...
							className="absolute bottom-full left-1/2 mb-2 w-fit -translate-x-1/2 whitespace-pre rounded-md border border-g-400 bg-white px-2 py-0.5 text-xs text-black shadow-md">
							{title}
						</motion.div>
					)}
				</AnimatePresence>
