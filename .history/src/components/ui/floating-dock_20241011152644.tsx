	...
	return (
		<>
			...
			<motion.div
				...
				initial="closed"
				className={cn('fixed bottom-8 right-8 z-[1000] flex items-center justify-center', className)}
				style={{
					width: isOpen ? '300px' : '64px',
					height: isOpen ? '300px' : '64px',
					borderRadius: '50%',
...
function IconContainer({ title, icon, href, index, totalItems }: IconContainerProps) {
	...
	const radius = 120 // Increase this value to spread icons further
