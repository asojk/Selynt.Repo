  ...
  return (
    <Link to={href}>
      <motion.div
        ...
        className='relative flex justify-between rounded-xl bg-white dark:bg-g-b'
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className='absolute bottom-full left-1/2 mb-2 w-fit -translate-x-1/2 rounded-md border border-g-400 bg-white px-2 py-0.5 text-xs text-g-900'
            >
              {title}
            </motion.div>
          )}
