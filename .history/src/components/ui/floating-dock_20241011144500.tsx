        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className='absolute bottom-full left-1/2 mb-2 w-fill -translate-x-1/2 text-4xl whitespace-pre rounded-md border border-g-400 bg-white px-2 py-0.5 text-g-900'
            >
              {title}
            </motion.div>
          )}
