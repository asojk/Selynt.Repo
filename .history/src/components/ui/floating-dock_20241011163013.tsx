				...
				<AnimatePresence>
					{hovered && (
						<motion.div
							...
							className="absolute bottom-full left-1/2 mb-2 w-fit -translate-x-1/2 whitespace-pre rounded-md border border-g-400 px-2 py-0.5 text-xs text-black shadow-md">
							{title}
						</motion.div>
					)}
				</AnimatePresence>
