				...
				<AnimatePresence>
					{hovered && (
						<motion.div
							...
							className="absolute bottom-full left-1/2 mb-2 w-fit -translate-x-1/2 whitespace-pre rounded-md border border-g-400 bg-white px-2 py-2 text-xs text-g-900">
							{title}
						</motion.div>
					)}
				</AnimatePresence>
