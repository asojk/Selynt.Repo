...
>
  ...
  initial='closed'
  className={cn(
    "fixed bottom-0 right-0 z-[1000] flex items-end justify-end border-[24rem] border-gradient-to-br from-white via-transparent to-transparent",
    className
  )}
  style={{
    scale,
    ...
    border: '24rem solid',
    borderImage: 'linear-gradient(to bottom right, white, transparent, transparent)',
    borderImageSlice: 1,
  }}
>
