...
<div
  className={cn(
    ...
    isOpen ? "w-[min(100vw,800px)] h-[min(100vw,800px)]" : "w-20 h-20",
    "rounded-tl-full origin-bottom-right",
    isOpen && "border-[6rem] border-solid border-white border-b-0 border-r-0",
    className
  )}
  style={{
    scale: scale.get(),
