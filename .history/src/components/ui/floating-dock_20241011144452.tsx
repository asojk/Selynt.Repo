				...
				<AnimatePresence>
					{hovered && (
						<motion.div
							...
							className="w-fill absolute bottom-full left-1/2 mb-2 -translate-x-1/2 whitespace-pre rounded-md border border-g-400 bg-white px-2 py-0.5 text-4xl text-xs text-g-900">
							{title}
						</motion.div>
					)}
				</AnimatePresence>
