	...
	return (
		<>
			...
			<motion.div
				...
				<motion.button
					className="absolute bottom-2 right-2 rounded-full border-8 border-white bg-white p-4 text-3xl text-black transition-colors hover:border-indigo-500 hover:text-indigo-500"
