...
>
  ...
  initial='closed'
  className={cn(
    "fixed bottom-0 right-0 z-[1000] flex items-end justify-end",
    className
  )}
  style={{
    scale,
    ...
    border: isOpen ? '20px solid rgba(255, 255, 255, 0.1)' : 'none',
    borderBottom: 'none',
    borderRight: 'none',
  }}
>
        ...
        <motion.button
          className='absolute right-2 bottom-2 rounded-full border-8 border-white bg-white p-4 text-3xl text-black transition-colors hover:border-indigo-500 hover:text-indigo-500'
