...
export default function Blurb() {
	return (
		<div className="flex min-h-screen flex-col items-center justify-center pt-36">
			<div className="mx-auto w-full px-4 py-12 text-center md:w-3/4 lg:w-2/3">
				<h2 className="pb-6 text-4xl font-bold tracking-tight text-a-dark dark:text-s lg:text-5xl">Coming soon...</h2>
				...
				<p className="mx-auto pb-8 text-base leading-relaxed text-n-8 dark:text-n-3 md:text-lg lg:text-xl">
