	...
	return (
		<div className="min-h-screen">
			<div className="container mx-auto px-4 py-12 text-center">
				<h2 className="text-3xl font-bold tracking-tight text-n-9 dark:text-white xl:text-4xl">Coming soon...</h2>
				<h3 className="mb-6 text-center text-xl font-semibold text-n-9 dark:text-white lg:text-2xl">
