...
const BeamInput = () => {
  ...
  return (
    <form
      ...
      className="relative flex w-full max-w-md items-center gap-2 rounded-full border-2 border-black/20 dark:border-white/20 bg-gradient-to-br from-primary to-p-900 py-1.5 pl-6 pr-1.5"
    >
      <input
        ref={inputRef}
        type="email"
        placeholder="Enter your email"
        className="w-full bg-transparent text-sm text-black dark:text-white placeholder-black/80 dark:placeholder-white/80 focus:outline-0"
      />
