...
const Copy = () => (
  <div className="max-w-lg text-center md:text-start">
    ...
    <a
      href="#"
      className="group text-sm uppercase text-p transition-colors hover:text-a dark:text-a dark:hover:text-s"
    >
      See case studies
      <IconCarambolaFilled className="inline-block ml-4 text-base transition-transform group-hover:rotate-45" />
    </a>
  </div>
);
