  ...
  return (
    ...
    >
      ...
      <button
        ...
        type="submit"
        className="group flex shrink-0 items-center hover:gap-1.5 rounded-full bg-gradient-to-br from-gray-50 to-gray-400 hover:px-4 py-3 text-sm font-medium text-gray-900 transition-transform active:scale-[0.985]"
      >
      ...
      <div className="pointer-events-none absolute inset-0 z-10 rounded-full">
        <motion.div
          ...
          className="mask-with-browser-support absolute -inset-[1px] rounded-full border border-transparent bg-origin-g-400"
        />
      </div>
    </form>
  );
