    ...
    <div className="mx-auto max-w-3xl px-4 md:py-24">
      ...
      <h2 className="text-center md:text-lg font-semibold text-g-b dark:text-white">
        BOOST CREDIBILITY &amp; TRUST WITH A        </h2>
          <a className="md:text-lg text-transparent bg-gradient-to-r from-primary to-accent p-2 bg-clip-text transition-colors in-range:animate-pulse font-semibold"> CLEAR IDENTITY</a>
