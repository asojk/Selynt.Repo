...
export const CountUpStats = () => {
  return (
    <div className="mx-auto max-w-3xl px-4 md:py-24">
      ...
      <h2 className="text-center md:text-lg font-semibold text-g-b dark:text-white">
          BOOST CREDIBILITY &amp; TRUST WITH A{' '}</h2>
          <a className="lg:pl-4 animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent text-3xl font-black"> CLEAR IDENTITY</a>
        </div>
...
const Stat = ({ num, suffix, decimals = 0, subheading }: Props) => {
  ...
  return (
    <div className="flex w-72 flex-col items-center py-8 sm:py-0">
      <p className="mb-2 text-center text-7xl font-semibold sm:text-6xl text-neutral-dark dark:text-neutral-light">
        <span ref={ref}></span>
        {suffix}
      </p>
