...
const BeamInput = () => {
  ...
  return (
    <form
      ...
      className="relative flex w-full max-w-md items-center gap-2 rounded-full border border-white/20 dark:border-black/20 bg-gradient-to-br from-primary to-p-900 py-1.5 pl-6 pr-1.5"
    >
      <input
        ref={inputRef}
        type="email"
