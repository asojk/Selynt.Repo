...
const BeamInput = () => {
  ...
  return (
    <form
      ...
      className="relative flex w-full max-w-md items-center gap-2 rounded-full border-2 border-black/10 dark:border-white/20 bg-gradient-to-br from-primary to-p-900 py-1.5 pl-6 pr-1.5"
    >
      <input
        ref={inputRef}
        type="email"
