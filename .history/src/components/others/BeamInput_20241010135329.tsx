...
const BeamInput = () => {
	...
	return (
		<form
			...
			className="to-p-900 relative flex w-full max-w-md items-center gap-2 rounded-full border-2 border-black/10 bg-gradient-to-br from-primary py-1.5 pl-6 pr-1.5 dark:border-white/20">
			<input
				ref={inputRef}
				type="email"
