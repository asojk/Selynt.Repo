...
import {Icon12Hours, IconAdjustmentsDown, IconCarambolaFilled, IconDesk, IconFlameOff, IconThumbUp} from '@tabler/icons-react'
      ...
      <LogoRolodex
        items={[
          <LogoItem key={1} className="bg-orange-300 text-neutral-900">
            <Icon12Hours className='items-center justify-center flex h-full w-full' />
          </LogoItem>,
          <LogoItem key={2} className="bg-green-300 text-neutral-900">
            <IconAdjustmentsDown className='items-center justify-center flex h-full w-full' />
          </LogoItem>,
          <LogoItem key={3} className="bg-blue-300 text-neutral-900">
            <IconDesk className='items-center justify-center flex h-full w-full' />
          </LogoItem>,
          <LogoItem key={4} className="bg-white text-black">
            <IconThumbUp className='items-center justify-center flex h-full w-full' />
          </LogoItem>,
          <LogoItem key={5} className="bg-purple-300 text-neutral-900">
            <IconFlameOff className='items-center justify-center flex h-full w-full' />
          </LogoItem>,
        ]}
      />
    </section>
...
const Copy = () => (
  <div className="max-w-lg text-center md:text-start">
    ...
    <a
      href="#"
      className="group text-sm uppercase text-primary transition-colors hover:text-p-500 dark:text-secondary dark:hover:text-accent"
    >
      See case studies
      <IconCarambolaFilled className="inline-block text-base transition-transform group-hover:rotate-45" />
    </a>
  </div>
);
...
const LogoItem = ({
  ...
  return (
    <div
      className={twMerge(
        "grid h-36 w-52 place-white-center rounded-lg bg-neutral-700 text-6xl text-neutral-50",
        className
      )}
    >
      {children}
