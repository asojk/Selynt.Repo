    ...
    <div className="mx-auto max-w-3xl px-4 md:py-24">
      ...
      <h2 className="text-center md:text-lg font-semibold text-g-b dark:text-white">
        BOOST CREDIBILITY &amp; TRUST WITH A        </h2>
          <a className="lg:ml-4 animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent text-5xl font-black"> CLEAR IDENTITY</a>
