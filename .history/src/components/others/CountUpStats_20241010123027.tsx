...
export const CountUpStats = () => {
  return (
    <div className="mx-auto max-w-3xl px-4 md:py-24">
      ...
      <h2 className="text-center text-xl font-semibold text-g-d dark:text-g-l">
...
const Stat = ({ num, suffix, decimals = 0, subheading }: Props) => {
  ...
  return (
    <div className="flex w-72 flex-col items-center py-8 sm:py-0">
      <p className="prose prose-text-black dark:prose-inverse mb-2 text-center text-7xl font-semibold sm:text-6xl">
        <span ref={ref}></span>
        {suffix}
      </p>
