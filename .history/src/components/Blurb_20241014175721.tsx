    ...
    <div className="h-screen pt-36">
      <div className="container mx-auto px-4 py-12">
        <h2 className="text-4xl font-bold lg:text-5xl tracking-tight pb-4 text-a-dark text-center dark:text-s">
          ...
          <h3 className="font-semibold text-xl lg:text-2xl text-center pb-8 text-n-9 dark:text-white mx-auto justify-center max-w-lg px-4">
            We empower small businesses to thrive in a market dominated by larger corporations.
            </h3>
        <p className="mt-4 block text-n-8 dark:text-n-3 font-semibold text-lg lg:text-xl mx-auto mb-8 max-w-2xl px-4">
