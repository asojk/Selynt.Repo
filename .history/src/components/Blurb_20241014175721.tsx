	...
	return (
		<div className="h-screen pt-36">
			<div className="container mx-auto px-4 py-12">
				...
				<h3 className="mx-auto max-w-lg justify-center px-4 pb-8 text-center text-xl font-semibold text-n-9 dark:text-white lg:text-2xl">
					We empower small businesses to thrive in a market dominated by larger corporations.
				</h3>
				<p className="mx-auto mb-8 mt-4 block max-w-2xl px-4 text-lg font-semibold text-n-8 dark:text-n-3 lg:text-xl">
