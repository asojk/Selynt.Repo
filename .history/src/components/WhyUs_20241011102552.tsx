			...
			<div className="container mx-auto flex flex-col items-center px-4 py-12 text-center">
				...
				<div className="mt-6">
					...
					<a
						...
						<span className="w-24px h-24px mx-2 h-5 w-5 fill-current">
							<svg className="h-[inherit] w-[inherit]" viewBox="-28 0 512 512.00075" xmlns="http://www.w3.org/2000/svg">
		...
		<section>
			<div className="container mx-auto flex flex-col items-center px-4 py-12 text-center">
				...
				<div className="mt-6 inline-flex w-full sm:w-auto">
					<a
						className="bg-primary-600 hover:bg-primary-500 focus:ring-primary-300 inline-flex w-full items-center justify-center rounded-lg px-6 py-2 text-white duration-300 focus:ring focus:ring-opacity-80"
						href="#"
						target="_self">
						Sign Up
					</a>
		...
		<section>
			<div className="container mx-auto px-6 py-10">
				<div className="text-center">
					<h2 className="text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">From the blog</h2>
