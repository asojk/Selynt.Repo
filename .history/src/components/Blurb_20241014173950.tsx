  ...
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12 text-center">
        <h2 className="text-3xl font-bold tracking-tight text-a-dark dark:text-s">
          Coming soon...
        </h2>
          <h3 className="font-semibold text-xl lg:text-2xl text-center mb-6 text-n-9 dark:text-white">
