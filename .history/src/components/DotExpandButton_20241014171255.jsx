	...
	return (
		<section className="grid place-content-center py-24">
			<a
				...
				className="group flex h-12 items-center gap-2 rounded-full bg-neutral-200 pl-3 pr-4 font-semibold transition-all duration-300 ease-in-out hover:bg-n-9 hover:pl-2 active:bg-neutral-700 dark:hover:text-s">
