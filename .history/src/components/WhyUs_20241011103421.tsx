			...
			<section>
				<div className="container mx-auto flex flex-col items-center px-4 py-12 text-center">
					...
					<div className="mt-6">
						...
						<a
							href="#"
							className="bg-primary-600 hover:bg-primary-500 focus:ring-primary-300 mt-4 inline-flex w-full items-center justify-center overflow-hidden rounded-lg px-4 py-2.5 text-sm text-white shadow transition-colors duration-300 focus:ring focus:ring-opacity-80 sm:mx-2 sm:mt-0 sm:w-auto">
							<span className="w-24px h-24px mx-2 h-5 w-5 fill-current">
								<svg
									className="h-[inherit] w-[inherit]"
