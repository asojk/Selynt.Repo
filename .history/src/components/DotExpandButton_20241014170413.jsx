	...
	return (
		<section className="grid place-content-center py-24">
			<a
				...
				className="group flex h-10 items-center gap-2 rounded-full bg-neutral-200 pl-3 pr-4 transition-all duration-300 ease-in-out hover:bg-n-dark hover:pl-2 hover:text-n-light active:bg-neutral-700">
				<span className="rounded-full bg-n-dark p-1 text-sm transition-colors duration-300 group-hover:bg-n-light">
