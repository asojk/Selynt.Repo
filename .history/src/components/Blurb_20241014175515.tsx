	...
	return (
		<div className="h-screen pt-36">
			<div className="container mx-auto px-4 py-12">
				<h2 className="pb-4 text-4xl font-bold tracking-tight text-a-dark dark:text-s lg:text-5xl">Coming soon...</h2>
				<h3 className="mx-auto max-w-lg justify-center pb-8 text-center text-xl font-semibold text-n-9 dark:text-white lg:text-2xl">
					We empower small businesses to thrive in a market dominated by larger corporations.
				</h3>
				<p className="mx-auto mb-8 mt-4 block max-w-md text-lg font-semibold text-n-8 dark:text-n-3 lg:text-xl">
