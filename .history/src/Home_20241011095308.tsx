...
export const Home = () => (
	<div className='bg-n-light dark:bg-n-dark antialiased'>
		<div className='relative flex flex-col justify-center items-center min-h-[90vh]'>
			...
			<div className='max-w-[85vw] relative'>
                {/* White Box */}
                <div className='hidden dark:flex bg-n-3 rounded-2xl w-[90vw] h-56 items-center justify-center absolute inset-0 z-[999]' />
