...
<div className="flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 bg-[#ffffff] rounded-2xl shadow-xl">
    ...
    <form className="flex flex-col">
        ...
        <button type="submit" className="w-full text-[#FFFFFF] bg-[#2d2977] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">Login</button>
...
{ /* pricing card 2 */}
  ...
  <div class="flex mx-auto justify-center items-center">
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 m-8">
          <div class="flex flex-col rounded-2xl w-full xl:w-96 bg-[#ffffff] text-[#374151] shadow-xl">
              ...
              <div class="flex flex-col p-8 h-full">
                  <div class="text-3xl text-center font-bold pb-6">Basic</div>
                  <div class=" text-center text-lg pb-12">Basic features. Get started completely for free.</div>
          ...
          <div class="flex flex-col rounded-2xl w-full xl:w-96 bg-[#ffffff] text-[#374151] shadow-xl">
              ...
              <div class="flex flex-col p-8 h-full">
                  <div class="text-3xl text-center font-bold pb-6">Pro</div>
                  <div class=" text-center text-lg pb-12">Get access to advanced features for increased productivity.</div>
                  <div class="flex flex-col gap-3  text-base">
                      <div class="flex flex-row gap-3">
                          <div class="text-green-600">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check">
