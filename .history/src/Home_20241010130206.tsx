...
export const Home = () => (
	<div className="bg-n-light antialiased dark:bg-n-dark">
		<div className="relative flex min-h-[90vh] flex-col items-center justify-end">
			...
			<div className="absolute left-1/3 top-0 -translate-x-1/2 transform">
				<div className="h-96 w-96 animate-float rounded-full bg-s opacity-70 blur-3xl filter backdrop-blur-3xl" />
			</div>
