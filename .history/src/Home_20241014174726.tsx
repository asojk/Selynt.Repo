	...
	<div className='bg-n-light antialiased dark:bg-n-dark'>
		<div className='relative flex min-h-screen flex-col items-center justify-end'>
			...
			<div className='mb-8 text-center'>
				<h1 className='text-wrap max-w-[60vw] md:max-w-none text-center justify-center items-center text-xl font-semibold text-n-dark dark:text-n-light md:text-4xl'>
