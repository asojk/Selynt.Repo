	...
	<div className="bg-n-light antialiased dark:bg-n-dark">
		<div className="relative flex min-h-screen flex-col items-center justify-end">
			...
			<div className="mb-8 text-center">
				<h1 className="max-w-[60vw] items-center justify-center text-wrap text-center text-xl font-semibold text-n-dark dark:text-n-light md:max-w-none md:text-4xl">
