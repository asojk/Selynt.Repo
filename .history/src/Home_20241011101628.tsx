...
*/}
			{ /* Floating Orb */}
				<div className=" absolute left-1/2 w-36 h-36 md:w-64 md:h-64 lg:w-96 lg:h-96 bg-s rounded-full md:-top-1/2 flex items-center justify-center inset-0 filter blur-3xl opacity-70 lg:opacity-40 animate-float z-[888]" />
