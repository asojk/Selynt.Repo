...
*/}
					{/* Floating Orb */}
					<div className="absolute inset-0 -top-3/4 left-1/2 z-[888] flex h-96 w-96 animate-float items-center justify-center rounded-full bg-s opacity-70 blur-3xl filter" />
