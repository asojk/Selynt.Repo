...
*/}
			{ /* Floating Orb */}
				<div className=" absolute left-1/2 w-36 h-36 md:w-64 md:h-48 lg:w-64 lg:h-96 bg-s rounded-full -top-1/2 flex items-center justify-center inset-0 filter blur-3xl opacity-70 animate-float z-[888]" />
