...
*/}
					{/* Floating Orb */}
					<div className="absolute inset-0 -top-1/2 left-1/2 z-[888] flex h-36 w-36 animate-float items-center justify-center rounded-full bg-s opacity-70 blur-3xl filter md:h-48 md:w-64 lg:h-96 lg:w-64" />
