	...
	<div className='bg-n-light dark:bg-n-dark antialiased'>
		<div className='relative flex flex-col justify-end items-center min-h-[90vh]'>
			...
			<div className='max-w-[85vw] relative'>
                {/* White Box */}
                <div className='hidden dark:flex bg-n-3 rounded-[2rem] w-auto h-52 items-center justify-center absolute inset-0 z-[999] backdrop=blur-3xl opacity-70 backdrop-filter ' />
