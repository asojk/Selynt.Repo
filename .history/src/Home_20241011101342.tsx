...
*/}
					{/* Floating Orb */}
					<div className="absolute inset-0 left-1/2 top-1/4 z-[888] flex h-96 w-96 animate-float items-center justify-center rounded-full bg-s opacity-70 blur-3xl filter" />
