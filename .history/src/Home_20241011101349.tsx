...
*/}
			{ /* Floating Orb */}
				<div className=" absolute left-1/2 w-96 h-96 bg-s rounded-full -top1/2 flex items-center justify-center inset-0 filter blur-3xl opacity-70 animate-float z-[888]" />
