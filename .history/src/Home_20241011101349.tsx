...
*/}
					{/* Floating Orb */}
					<div className="-top1/2 absolute inset-0 left-1/2 z-[888] flex h-96 w-96 animate-float items-center justify-center rounded-full bg-s opacity-70 blur-3xl filter" />
