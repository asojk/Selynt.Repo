...
export const Home = () => (
	<div className='bg-n-light dark:bg-n-dark antialiased'>
		<div className='relative flex flex-col justify-end items-center min-h-[90vh]'>
			...
			{/* White Box */}
				<div className='hidden dark:flex bg-n-5 rounded-[2rem] w-auto h-36 items-center bg-blend-multiply justify-center absolute inset-0 mt-6 z-[999] backdrop=blur-3xl opacity-70 backdrop-filter filter-blur blur-2xl' />

			{ /* Floating Orb */}
				<div className=" absolute w-96 h-96 bg-s rounded-full flex items-center justify-center inset-0 filter blur-3xl opacity-70 animate-float z-[888]" />
