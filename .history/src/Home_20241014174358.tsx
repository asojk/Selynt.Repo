	...
	<div className='bg-n-light antialiased dark:bg-n-dark'>
		<div className='relative flex min-h-screen flex-col items-center justify-end'>
			...
			<div className='mb-8 text-center'>
				<h1 className='prose text-xl font-semibold text-n-dark dark:text-n-light md:text-4xl'>
					Boost Credibility with a{' '}
					<a className='prose animate-text bg-gradient-to-r from-p via-s to-a-darker bg-clip-text text-transparent'>
						{' '}
						Clear Identity
					</a>
				</h1>
