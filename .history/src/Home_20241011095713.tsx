		...
		<div className="relative flex min-h-[90vh] flex-col items-center justify-end">
			...
			<div className="absolute top-1/3 z-[1000]">
				<div className="relative max-w-[85vw]">
					{/* White Box */}
					<div className="backdrop=blur-3xl filter-blur absolute inset-0 z-[999] mt-8 hidden h-36 w-auto items-center justify-center rounded-[2rem] bg-n-3 opacity-70 blur-2xl backdrop-filter dark:flex" />
