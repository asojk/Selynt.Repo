		...
		<section className="bg-p-light py-16 dark:bg-p-dark">
			<div className="mx-auto max-w-7xl text-center">
				...
				<a
					...
					className="hover:bg-alternative-dark dark:hover:bg-alternative-light mt-8 inline-block rounded-lg bg-a px-6 py-3 text-white transition">
					Contact Us
				</a>
			</div>
		</section>
		...
		<>
			...
			<div className="3xl:w-1/3 3xl:p-14 mx-auto flex w-full flex-col rounded-2xl bg-[#ffffff] p-8 shadow-xl md:w-1/2 md:p-10 xl:w-2/5 2xl:w-2/5 2xl:p-12">
				...
				<form className="flex flex-col">
					...
					<button
						type="submit"
						className="focus:ring-primary-300 mb-6 w-full rounded-lg bg-[#2d2977] px-5 py-2.5 text-center text-sm font-medium text-[#FFFFFF] focus:outline-none focus:ring-4">
						Login
					</button>
