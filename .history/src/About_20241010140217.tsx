...
<section className="py-16 bg-p-light dark:bg-p-dark">
  <div className="max-w-7xl mx-auto text-center">
    ...
    <a href="mailto:contact@selynt.com" className="mt-8 inline-block bg-a py-3 px-6 rounded-lg text-white hover:bg-alternative-dark dark:hover:bg-alternative-light transition">
      Contact Us
    </a>
  </div>
    </section>
