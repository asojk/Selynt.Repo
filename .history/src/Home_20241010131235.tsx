	...
	<div className="bg-n-light antialiased dark:bg-n-dark">
		<div className="relative flex min-h-[90vh] flex-col items-center justify-end">
			...
			<div className="mb-8 text-center">
				<h1 className="text-4xl font-semibold text-n-dark dark:text-n-light">
					Boost Trust &amp; Credibility with a{' '}
					<a className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">
						{' '}
						Clear Identity
					</a>
				</h1>
				<p className="mt-2 text-n-5 dark:text-n-4">How to use Typescript types for Tailwind-CSS</p>
				<h2 className="text-center text-xl font-semibold text-n-dark dark:text-n-light">
					BOOST CREDIBILITY &amp; TRUST WITH A{' '}
				</h2>
				<a className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-2xl font-black text-transparent lg:pl-4">
					{' '}
					CLEAR IDENTITY
				</a>
			</div>
