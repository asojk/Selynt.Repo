...
export const Home = () => (
	<div className="bg-n-light antialiased dark:bg-n-dark">
		<div className="relative flex min-h-[90vh] flex-col items-center">
			{/* Floating Orb */}
			<div className="absolute top-1/3 z-[1000]">
				<div className="relative max-w-[85vw]">
					{/* White Box */}
					<div className="absolute inset-0 z-[999] hidden h-56 w-[90vw] items-center justify-center rounded-2xl bg-n-3 dark:flex" />
